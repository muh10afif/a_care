    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?= base_url() ?>admin/<?= $this->session->userdata('level'); ?>">
                ...
                <span class="logo-text">
                        <!-- dark Logo text -->
                        <img src="<?= base_url() ?>template/assets/images/logo-text-acare.png" alt="homepage" class="dark-logo" />
                        <!-- Light Logo text -->    
                        <!-- <img src="<?= base_url() ?>template/img/logo.png" width="80%" class="light-logo" alt="homepage" /> -->
                        <img src="<?= base_url() ?>template/img/logo-text-acare.png" class="light-logo" alt="homepage" />
                </span>
            </a>
            <!-- ============================================================== -->
            <!-- End Logo -->
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav float-left mr-auto">
                ...
                <h1 class="mt-2"><b style="color:#122E5D; font-size: 25px; font-weight: bold; text-shadow: 1px 0.4px 0.5px #000;">Assets Care</b></h1>
            </ul>
            <!-- ============================================================== -->
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        <a class="dropdown-item mt-2" href="<?= base_url('login/logout') ?>"><i class="fa fa-power-off mr-1 ml-1"></i> Logout</a>
                    </div>
                </li>
                <!-- ============================================================== -->
                <!-- User profile and search -->
