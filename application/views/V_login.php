...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?= base_url();?>template/login/images/bg-2.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form class="login100-form validate-form p-b-33 p-t-5" id="form-login" method="post" autocomplete="off">
					...
					<div class="wrap-input100 text-center" style="margin-top: -10px;">
                        ...
                        <h2 class="mb-2"><b style="color:#122E5D; font-size: 30px; font-weight: bold; text-shadow: 0.6px 0.5px 0.5px #000;">A - Care</b></h2>
                    </div>
                    ...
                    success     : function (data) {
                        ...
                        if (data.hasil == 2) {
                          ...
                          window.location.href = url;
                            ...
                            swal({
                                title 	: 'Gagal',
                                text 	: 'Masukkan username sistem A-care!!',
                                type 	: 'error',
                                timer 	: 1000,
