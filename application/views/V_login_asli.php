            ...
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        ...
                        <!-- <span class="db mb-2"><img src="<?= base_url() ?>template/img/logo.png" width="80%" alt="logo" /></span> -->
                        ...
                        <!-- <h1 class="font-medium mb-3" style="font-weight: bold; font-size: 40px;">D - Care</h1> -->
                        <!-- <span class="db mb-2"><img src="<?= base_url() ?>template/img/logo-sps.png" width="80%" alt="logo" /></span> -->
                        <h1 class="mb-2"><b style="color:#122E5D; font-size: 30px; font-weight: bold; text-shadow: 1px 1px 1px #000;">A - Care</b></h1>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
